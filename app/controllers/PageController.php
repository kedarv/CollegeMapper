...
class PageController extends BaseController {
	...
	public function stats() {
		...
		foreach($query as $row) {
			...
			if(strpos($row['major'], "Child Psychology") !== false || strpos($row['major'], "Linguistics") !== false || strpos($row['major'], "Sociology") !== false || strpos($row['major'], "Kinesiology") !== false || strpos($row['major'], "Art") !== false || strpos($row['major'], "Music Cognition") !== false || strpos($row['major'], "Media") !== false || strpos($row['major'], "Architecture") !== false || strpos($row['major'], "Psychology") !== false || strpos($row['major'], "Agriculture and Consumer Economics") !== false || strpos($row['major'], "Biology") !== false || strpos($row['major'], "Political Science") !== false || strpos($row['major'], "Theatre") !== false || strpos($row['major'], "History") !== false || strpos($row['major'], "English") !== false) {
